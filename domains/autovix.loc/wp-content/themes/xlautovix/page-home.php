        ...
        <div class="main-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider-bg.jpg" alt="img" class="kenburns"
                            style="animation-duration: 12000ms; "></div>
                    <div class="car-holder">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car" data-animation="car-animation" data-duration="1.5s">
                        <div class="shape">
    ...
    <section class="about-section padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="about-img">
                        <img class="about-img1 wow fade-in-left" data-wow-delay="200ms" src="<?php echo get_template_directory_uri(); ?>/assets/img/about-1.png" alt="img">
                        <img class="about-img2 wow fade-in-bottom" data-wow-delay="400ms" src="<?php echo get_template_directory_uri(); ?>/assets/img/about-2.png" alt="img">
                        <figure class="round-text"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/experience-text-round.png" alt="img"></figure>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <ul class="about-info wow fade-in-right" data-wow-delay="400ms">
                        <li>
                            <img class="owner-thumb" src="<?php echo get_template_directory_uri(); ?>/assets/img/comment-1.png" alt="thumb">
                            <div class="owner">
                                <h4>Founder - CEO</h4>
                                <img class="signature" src="<?php echo get_template_directory_uri(); ?>/assets/img/signature.png" alt="signature">
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-item wow fade-in-bottom" data-wow-delay="200ms">
                                <div class="service-thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service-1.jpg" alt="img">
                                    <div class="service-shape-wrap">
                                        <div class="service-shape"></div>
                                    </div>
                                    <div class="service-car"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car"></div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item wow fade-in-bottom" data-wow-delay="400ms">
                                <div class="service-thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service-2.jpg" alt="img">
                                    <div class="service-shape-wrap">
                                        <div class="service-shape"></div>
                                    </div>
                                    <div class="service-car"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item wow fade-in-bottom" data-wow-delay="600ms">
                                <div class="service-thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service-3.jpg" alt="img">
                                    <div class="service-shape-wrap">
                                        <div class="service-shape"></div>
                                    </div>
                                    <div class="service-car"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service-4.jpg" alt="img">
                                    <div class="service-shape-wrap">
                                        <div class="service-shape"></div>
                                    </div>
                                    <div class="service-car"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-thumb">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service-5.jpg" alt="img">
                                    <div class="service-shape-wrap">
                                        <div class="service-shape"></div>
                                    </div>
                                    <div class="service-car"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/car-1.png" alt="car"></div>
                            ...
                            <div class="pricing-item">
                                <div class="pricing-head-wrap">
                                    <div class="pricing-car">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pricing-car.png" alt="car">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading wow fade-in-left" data-wow-delay="200ms">
                        ...
                        <ul class="app-feature">
                            <li>
                                <i><img class="feature-icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-navigator.svg" alt="icon"></i>
                                <h3>Easy to Search <br> Ridek Taxi!</h3>
                            </li>
                            <li>
                                <i><img class="feature-icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-clock.svg" alt="icon"></i>
                                <h3>Quick Pickups To <br> Save Time!</h3>
                            </li>
                            <li>
                                <i><img class="feature-icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-docs.svg" alt="icon"></i>
                                <h3>Inclusive Rates To<br> Enjoy Ride!</h3>
                            </li>
                        </ul>
                        <div class="download-btn">
                            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/google-play.svg" alt="PlayStore"></a>
                            <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/app-store.svg" alt="AppStore"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="taxi-holder">
                        ...
                        <img class="location-marker" src="<?php echo get_template_directory_uri(); ?>/assets/img/location-marker.png" alt="location">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testi-item">
                                        ...
                                        <div class="testi-author">
                                            <div class="author-thumb"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/comment-1.png" alt="author">
                                            </div>
        ...
        <div class="container">
            ...
            <div class="row grid-post">
                <div class="col-lg-4 col-md-6 padding-15">
                    <div class="post-card">
                        <div class="post-thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/post-1.jpg" alt="post">
                ...
                <div class="col-lg-4 col-md-6 padding-15">
                    <div class="post-card">
                        <div class="post-thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/post-2.jpg" alt="post">
                ...
                <div class="col-lg-4 col-md-6 padding-15">
                    <div class="post-card">
                        <div class="post-thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/post-3.jpg" alt="post">
