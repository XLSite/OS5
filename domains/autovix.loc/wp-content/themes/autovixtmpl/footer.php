                            ...
                            <div class="footer-service footer-find">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        г.Одинцово, ул. Транспортная, д.5
                                    </li>
                                    <li>
                                        <i class='bx bx-phone-call'></i>
                                        <a href="tel:+79166201779">
                                            +7 (916) 620-17-79
                                        </a>
                                    </li>
                                    <li>
                                        <i class='bx bx-phone-call'></i>
                                        <a href="tel:+79261233825">
                                            +7 (926) 123-38-25
                                        </a>
                                    </li>
                                    <li>
                                        <i class='bx bx-mail-send'></i>
                                        <a href="mailto:volvo@autovix.ru">
                                            volvo@autovix.ru
                                        </a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="copyright-item">
                                <p>Copyright ©1997-2025 AutoVix. Designed By <a href="https://xlsite.ru/" target="_blank">XL Site Studio</a></p>
                            </div>
                        </div>
                        <div class="col-lg-5">
